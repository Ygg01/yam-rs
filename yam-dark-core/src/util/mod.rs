...
pub fn count_table_small(
    ...
    byte_rows[0..8].copy_from_slice(&col_rows);

    let mask = (newline_mask & 0xFF00) >> 8;
    ...
    let mask = (newline_mask & 0xFF_0000) >> 16;
    ...
    let mask = (newline_mask & 0xFF00_0000) >> 24;
    ...
    let mask = (newline_mask & 0xFF_0000_0000) >> 32;
    ...
    let mask = (newline_mask & 0xFF00_0000_0000) >> 40;
    ...
    let mask = (newline_mask & 0xFF_0000_0000_0000) >> 48;
    let col_result =
    ...
    let mask = (newline_mask & 0xFF00_0000_0000_0000) >> 56;

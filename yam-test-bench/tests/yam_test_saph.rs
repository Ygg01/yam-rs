...
use yam_test_bench::{assert_eq_event_case_with_opts, FormatOpts, ParsingOptions};
...
#[case::block_lit_fold_err(FOLD_ERR_INPUT, FOLD_ERR_EVENTS_SAPH)]
...
#[rstest]
#[case::docs_empty_input(EMPTY_DOC_INPUT, EMPTY_DOC_EVENTS_SAPH)]
